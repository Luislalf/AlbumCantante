...
urlpatterns = [
    ...
    url(r'^musico/(?P<pk>[0-9]+)/comentario2/$',views.vista_comentario2, name='vista_comentario2'),
    url(r'^musico/Nuevo_Album/$', views.nuevo_album, name='nuevo_album'),
    url(r'^musico/Nuevo_Músico/$', views.nuevo_musico, name='nuevo_musico'),
    url(r'^musico/(?P<pk>[0-9]+)/editar', views.editar_albumm, name='editar_albumm'),
    url(r'^musico/(?P<pk>[0-9]+)/editar2', views.editar_musico, name='editar_musico'),
